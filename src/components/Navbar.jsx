...
const Navbar = ({ userName }) => {
    ...
    const buttonMappings = [
        { id: "b1", text: "Home", icon: <i className="fas fa-file-alt"></i>,path:'/' },
        { id: "b5", text: "Task List", icon: <i className="fas fa-cloud"></i>,path:'/tasklist' },
        { id: "b4", text: "Stastic", icon: <i className="fas fa-history"></i>,path:'/stastic' },
        { id: "b2", text: "History", icon: <i className="fas fa-comment"></i>,path:'/history' },
        { id: "b3", text: "feddback", icon: <i className="fas fa-house-user"></i>,path:'/feedback' }
    ];
